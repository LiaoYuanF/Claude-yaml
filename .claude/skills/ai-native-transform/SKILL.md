...
description: >
  Use when the user asks to "make this codebase AI-native", "add CLAUDE.md",
  "set up for Claude Code", "improve AI collaboration", "transform codebase",
  or mentions making a repo more suitable for AI agent development.
user-invocable: true
...
Skill 目录结构：`.claude/skills/<name>/SKILL.md`
