...
name: debug-perf
description: >
  Use when the user reports performance issues: "latency increased", "throughput dropped",
  "OOM", "GPU utilization low", "TTFT regression", "P99 spike", or asks to
  "investigate performance", "debug slowness", "find the bottleneck".
user-invocable: true
context: fork
agent: Explore
